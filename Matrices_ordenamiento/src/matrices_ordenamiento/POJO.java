...
public class POJO {
    ...
    public  void ordenar_calificaciones(){
        ...
        for (int i = 0; i < calificacion.length ; i++) {
            ...
            for (int j = 0; j < calificacion.length - 1; j++) { /* Si el número almacenado en la posición j es menor que el de la posición j+1 (el siguiente del array) */ 
                
                if (calificacion[i][j] < calificacion[i][j+1]) {
                    /* guardamos el número de la posicion j+1 en una variable (el menor) */
                   
                     temp =  calificacion[i][j];
                     
                    /* Lo intercambiamos de posición */
                    
                    calificacion[i][j] = calificacion[i][j+1];
                    
                    calificacion[i][j] = temp;
                    ...
                    /* de esta forma vamos dejando los números mayores al final del array en orden*/
                     ...
                     data += "Nombre: " + nombre[i][j] + "\n";

                     data += "Nota  :" + calificacion[i][j] + "\n";
    ...
    public void mostrar_por_id(){
        ...
        String opcion;
        Object TyOpcion[] = {"101510","101516","101519","101520","101545",
                "101512","101508"};

        Object lista_opciones = JOptionPane.showInputDialog(null," ¿Which is the car Brand? \n"
                        +"Notas registradas",
                "Lista de notas ",
        ...
        if(lista_opciones.equals("101516")){
            String nota = "La nota del alumno es: \n";
        ...
        if(lista_opciones.equals("101519")){
            String nota = "La nota del alumno es: \n";
        ...
        if(lista_opciones.equals("101520")){
            String nota = "La nota del alumno es: \n";
        ...
        if(lista_opciones.equals("101545")){
            String nota = "La nota del alumno es: \n";
        ...
        if(lista_opciones.equals("101512")){
            String nota = "La nota del alumno es: \n";
        ...
        if(lista_opciones.equals("101508")){
            String nota = "La nota del alumno es: \n";
